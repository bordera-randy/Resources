...
## Table of Contents
1. [Implement and Manage User Identities](#implement-and-manage-user-identities-20-25)
2. [Configure and Manage a Microsoft Entra Tenant](#configure-and-manage-a-microsoft-entra-tenant)
3. [Built-In and Custom Microsoft Entra Roles](#built-in-and-custom-microsoft-entra-roles)
   - [Built-In Roles](#built-in-roles)
   - [Custom Roles](#custom-roles)
4. [Links to Relevant Study Material](#links-to-relevant-study-material)
5. [Labs and Study Guides](#labs-and-study-guides)
6. [Tips for Taking the Exam](#tips-for-taking-the-exam)
7. [Schedule the Exam](#schedule-the-exam)
8. [Exam Coverage and Job Roles](#exam-coverage-and-job-roles)
   - [Exam Coverage](#exam-coverage)
   - [Job Roles](#job-roles)
9. [Study Guide](#study-guide)
   - [Implement and Manage User Identities](#implement-and-manage-user-identities-20-25)
   - [Configure and Manage a Microsoft Entra Tenant](#configure-and-manage-a-microsoft-entra-tenant)
   - [Configuring and Managing Built-In and Custom Microsoft Entra Roles](#configuring-and-managing-built-in-and-custom-microsoft-entra-roles)
   - [Administrative Units](#administrative-units)
   - [Evaluating Effective Permissions for Microsoft Entra Roles](#evaluating-effective-permissions-for-microsoft-entra-roles)
   - [Configuring and Managing Custom Domains](#configuring-and-managing-custom-domains)
   - [Configuring Company Branding Settings](#configuring-company-branding-settings)
   - [Configuring Tenant Properties, User Settings, Group Settings, and Device Settings](#configuring-tenant-properties-user-settings-group-settings-and-device-settings)
   - [Create, Configure, and Manage Microsoft Entra Identities](#create-configure-and-manage-microsoft-entra-identities)
   - [Implement and Manage Identities for External Users and Tenants](#implement-and-manage-identities-for-external-users-and-tenants)
   - [Implement and Manage Hybrid Identity](#implement-and-manage-hybrid-identity)
   - [Implement Authentication and Access Management](#implement-authentication-and-access-management-25-30)
   - [Plan, Implement, and Manage Microsoft Entra User Authentication](#plan-implement-and-manage-microsoft-entra-user-authentication)
   - [Plan, Implement, and Manage Microsoft Entra Conditional Access](#plan-implement-and-manage-microsoft-entra-conditional-access)
   - [Manage Risk by Using Microsoft Entra ID Protection](#manage-risk-by-using-microsoft-entra-id-protection)
   - [Implement Access Management for Azure Resources by Using Azure Roles](#implement-access-management-for-azure-resources-by-using-azure-roles)
   - [Plan and Implement Workload Identities](#plan-and-implement-workload-identities-20-25)
   - [Plan and Implement Identities for Applications and Azure Workloads](#plan-and-implement-identities-for-applications-and-azure-workloads)
   - [Plan, Implement, and Monitor the Integration of Enterprise Applications](#plan-implement-and-monitor-the-integration-of-enterprise-applications)
   - [Plan and Implement App Registrations](#plan-and-implement-app-registrations)
   - [Manage and Monitor App Access by Using Microsoft Defender for Cloud Apps](#manage-and-monitor-app-access-by-using-microsoft-defender-for-cloud-apps)
   - [Plan and Implement Identity Governance](#plan-and-implement-identity-governance-20-25)
   - [Plan and Implement Entitlement Management in Microsoft Entra](#plan-and-implement-entitlement-management-in-microsoft-entra)
   - [Plan, Implement, and Manage Access Reviews in Microsoft Entra](#plan-implement-and-manage-access-reviews-in-microsoft-entra)
   - [Plan and Implement Privileged Access](#plan-and-implement-privileged-access)
   - [Monitor Identity Activity by Using Logs, Workbooks, and Reports](#monitor-identity-activity-by-using-logs-workbooks-and-reports)
   - [Plan and Implement Microsoft Entra Permissions Management](#plan-and-implement-microsoft-entra-permissions-management)
...
## Links to Relevant Study Material
- [Microsoft Learn: SC-300 Exam](https://learn.microsoft.com/en-us/certifications/exams/sc-300)
- [Microsoft Entra Documentation](https://learn.microsoft.com/en-us/azure/active-directory/fundamentals/entra-overview)
- [Microsoft Entra Roles and Permissions](https://learn.microsoft.com/en-us/azure/active-directory/roles/permissions-reference)

## Labs and Study Guides
- [Microsoft Learn Labs](https://learn.microsoft.com/en-us/training/azure/)
- [Pluralsight SC-300 Course](https://www.pluralsight.com/courses/microsoft-entra-identity-governance-sc-300)
- [Udemy SC-300 Practice Tests](https://www.udemy.com/course/sc-300-microsoft-identity-and-access-administrator/)

## Tips for Taking the Exam
- Review the official Microsoft documentation and study guides.
- Take practice exams to familiarize yourself with the exam format.
- Focus on understanding the core concepts and practical applications.
- Join study groups or forums to discuss topics with peers.

## Schedule the Exam
- [Schedule SC-300 Exam](https://learn.microsoft.com/en-us/certifications/exams/sc-300)

## Exam Coverage and Job Roles
### Exam Coverage
