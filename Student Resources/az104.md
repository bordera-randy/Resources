...
- **Resource independence**: Resources in one directory do not have access to resources in another directory
...
- AD > User > New User
- **User name**: Required, e.g. test@contoso.onmicrosoft.com
...
- Multi Forest synchronization
  - Are the UPNs unique in your organization?
    - More than one forest: You can call people the same thing as other people. You won't be able to do that in single Azure AD as they need unique UPNs.
